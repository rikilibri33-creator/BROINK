...
function hardcodedAI_lvl_02(_game, _playerSelf, _playerOther) constructor
{
	game = _game
	...
	function Step()
	{
		if (game.barrier_left > 0)
		{
			ModeOpening()
			return;
		}
		
		xoutput = playerOther.xpos-playerSelf.xpos 
		youtput = playerOther.ypos-playerSelf.ypos 
		xoutput += -playerSelf.xspeed * 4
		youtput += -playerSelf.yspeed * 4
	...
	function OutOfBoundsEmergencyBreak()
	{
		...
		var fakeradius = game.game_radius - 10
